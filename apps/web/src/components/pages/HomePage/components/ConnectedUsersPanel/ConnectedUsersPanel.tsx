...
const ConnectedUsersPanel: React.FC = () => {
  ...
  return (
    <Panel className="h-12 z-10 fixed top-4 right-[4.5rem] flex flex-row items-center gap-2 px-3">
      ...
      <div className="hidden sm:flex -space-x-1.5">
        ...
        {connections?.map((conn: any) => {
          ...
          return (
            <div key={conn.id} className="w-4 h-4 rounded-full relative" style={{ backgroundColor: `hsl(${hue}, 70%, 60%)` }}>
              {/* {conn.user_id} */}
